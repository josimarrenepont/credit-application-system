...
class CreditRepositoryTest {
    ...
    fun `should find credit by credit code`() {
        ...
        //when
        `when`(creditRepository.findByCreditCode(creditCode1)).thenReturn(credit1)
        `when`(creditRepository.findByCreditCode(creditCode2)).thenReturn(credit2)
    ...
    fun `should find all credits by customer id`() {
        ...
        //when
        `when`(creditRepository.findAllByCustomerId(customerId)).thenReturn(listOf(credit1, credit2))
